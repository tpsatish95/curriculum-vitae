...
under by Rajesh Ramachandran, Chief Technology Officer \& President
\begin{itemize}
\item \textbf{Projects:} 
\begin{itemize}
\item Scalable, \textbf{deep-learned, viewer-demographics mining engine} (count, age, gender, and emotions of the movie watchers), from low-light images of a theatre's auditorium.
...
\end{itemize}
\item \textbf{Techniques and Tools:} CNN with master-child model \& feedback-based learning, Generative Adversarial Networks (GAN), Camera Calibration, Amazon Web Services, Flask+uWSGI+Nginx servers.
...
\cvitem{}{- \textbf{Mentored and advised a tech startup} that digitizes hardware inventory management in post offices and makes it more intelligent, we were the \textbf{$2^{nd}$ Runners-up} (Dept. of Posts) in \textbf{Smart India Hackathon} (world's largest hackathon), organized and \textbf{incubated by the Government of India}.}
